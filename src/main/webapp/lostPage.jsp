...
<body class="container py-5">
    <div class="text-bg-light p-3">
        <h1 class="position-absolute top-10 start-50 translate-middle"> Имя игрока: <c:out value="${sessionScope.userName}">userName</c:out></h1>
        <p><c:out value="${sessionScope.userName}">userName</c:out>, <c:out value="${requestScope.defeatPhrase}">defeatPhrase</c:out></p>
